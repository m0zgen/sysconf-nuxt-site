<template>
  <section class="black section-content">
    <div class="container">
      ...
      <div class="columns pt-6 mb-6 is-multiline is-centered">
        <div class="column is-8 has-text-centered">
          ...
          <p class="subtitle has-text-grey">
            "Человек наделен огромным запасом творческих сил, у большинства людей они дремлют не разбуженными, пробудить эти силы и есть наша главная задача.", -
            <a href="https://ru.wikipedia.org/wiki/%D0%A5%D0%B0%D1%80%D0%BB%D0%B0%D0%BC%D0%BF%D0%B8%D0%B5%D0%B2,_%D0%90%D0%BD%D0%B0%D1%82%D0%BE%D0%BB%D0%B8%D0%B9_%D0%90%D1%80%D0%BA%D0%B0%D0%B4%D1%8C%D0%B5%D0%B2%D0%B8%D1%87" target="_blank">А.Харлампиев</a>.
          </p>
        </div>
      </div>
              ...
              <div class="box has-background-light is-box-100">
                <div class="is-vcentered columns is-multiline">
                  ...
                  <div class="column is-7">
                    ...
                    <p>
                      Кодим Rx, Tx функционалы на С, описывая теорию (OFDM/SC-OFDM демодуляция, логические и транспорт каналы 4G, 5G), подводные камни имплементации.
                      Анализируем трафик.
                    </p>
                  </div>
                </div>
...
<!--            </div>-->
    ...
    <!--    <div v-for="user in content.users">-->
    <!--      {{user.name}}-->
    <!--    </div>-->
  </section>
